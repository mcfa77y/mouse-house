...
module.exports = {
    up: (queryInterface, Sequelize) => queryInterface.createTable('Molecules', {
        ...
        max_solubility: { type: Sequelize.DOUBLE, defaultValue: -1.0, allowNull: true },
        molarity_mm: { type: Sequelize.DOUBLE, defaultValue: -1.0, allowNull: true },
        ...
        weight: { type: Sequelize.DOUBLE, defaultValue: -1.0, allowNull: true },
